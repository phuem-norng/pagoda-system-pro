...
<table>
  ...
  <tbody>
    <?php
    $members = [
      ["id" => 1, "name" => "សៅ ថុង", "age" => 13, "photo" => "p1.jpg"]
    ];
    $i = 1;
    ...
    <?php
    $members = [
      ["id" => 2, "name" => "ប៊ុន ចាន់ខ្លូ", "age" => 18, "photo" => "p2.jpg"]
    ];
    $i = 2;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 3, "name" => "ស៊ាម វី", "age" => 4, "photo" => "p3.jpg"]
    ];
    $i = 3;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 12, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p12.jpg"]
    ];
    $i = 12;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 13, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p13.jpg"]
    ];
    $i = 13;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 14, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p14.jpg"]
    ];
    $i = 14;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 15, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p15.jpg"]
    ];
    $i = 15;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 16, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p16.jpg"]
    ];
    $i = 16;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 17, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p17.jpg"]
    ];
    $i = 17;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 18, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p18.jpg"]
    ];
    $i = 18;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 19, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p19.jpg"]
    ];
    $i = 19;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 20, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p20.jpg"]
    ];
    $i = 20;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 21, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p21.jpg"]
    ];
    $i = 21;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 22, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p22.jpg"]
    ];
    $i = 22;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 23, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p23.jpg"]
    ];
    $i = 23;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 24, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p24.jpg"]
    ];
    $i = 24;
    foreach ($members as $m) {
    ?>
    ...
    <?php
    $members = [
      ["id" => 25, "name" => "ធន ចន្ធី", "age" => 9, "photo" => "p25.jpg"]
    ];
    $i = 25;
    foreach ($members as $m) {
    ?>
...
<div class="green-footer">
  "សរុបចំនួនទាំងអស់៖ ២៥អង្គ ភិក្ខុ=២០ ​អង្គ សាមណេរ=៥ អង្គ​"
</div>
